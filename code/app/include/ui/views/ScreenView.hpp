...
private:
  ...
  enum class CoordinateType { LEFT_HANDED, RIGHT_HANDED };
  ...
  enum class ViewType { PREVIEW, RESULT };
...
public:
  ScreenView(const Vec2& position, const Vec2& size, UIContext& uiContext,
    Manager& manager);
};
}  // namespace NRenderer
