...
// User defines: GLM_FORCE_CXX98, GLM_FORCE_CXX03, GLM_FORCE_CXX11, GLM_FORCE_CXX14, GLM_FORCE_CXX17, GLM_FORCE_CXX2A
  ...
  #define GLM_LANG_CXXGNU GLM_LANG_CXXGNU_FLAG
    ...
    #define GLM_LANG (GLM_LANG_CXX98 | GLM_LANG_EXT)
      ...
      #define GLM_LANG (GLM_LANG_CXX17 | GLM_LANG_EXT)
    #elif __cplusplus == 201402L || __cplusplus == 201406L || \
      __cplusplus == 201500L || GLM_LANG_PLATFORM == 201402L
      #define GLM_LANG (GLM_LANG_CXX14 | GLM_LANG_EXT)
...
// Configure the use of defaulted function
    ...
    GLM_CONFIG_DEFAULTED_FUNCTIONS == GLM_ENABLE
...
// Precision
  ...
  #if defined(GLM_FORCE_PRECISION_HIGHP_BOOL) || \
    defined(GLM_PRECISION_HIGHP_BOOL)
  ...
  #elif defined(GLM_FORCE_PRECISION_LOWP_BOOL) || \
  ...
  #if defined(GLM_FORCE_PRECISION_HIGHP_UINT) || \
  ...
  #elif defined(GLM_FORCE_PRECISION_LOWP_UINT) || \
...
#elif ( \
  (GLM_SETUP_INCLUDED != GLM_VERSION) && !defined(GLM_FORCE_IGNORE_VERSION))
  #error \
...
// Messages
  ...
  // Report build target
      ...
      #pragma message( \
        "GLM: x86 64 bits with SSE4.2 instruction set build target")
    #elif (GLM_ARCH & GLM_ARCH_SSE42_BIT) && (GLM_MODEL == GLM_MODEL_32)
      #pragma message( \
        "GLM: x86 32 bits with SSE4.2 instruction set build target")

    #elif (GLM_ARCH & GLM_ARCH_SSE41_BIT) && (GLM_MODEL == GLM_MODEL_64)
      #pragma message( \
        "GLM: x86 64 bits with SSE4.1 instruction set build target")
    #elif (GLM_ARCH & GLM_ARCH_SSE41_BIT) && (GLM_MODEL == GLM_MODEL_32)
      #pragma message( \
        "GLM: x86 32 bits with SSE4.1 instruction set build target")

    #elif (GLM_ARCH & GLM_ARCH_SSSE3_BIT) && (GLM_MODEL == GLM_MODEL_64)
      #pragma message( \
        "GLM: x86 64 bits with SSSE3 instruction set build target")
    #elif (GLM_ARCH & GLM_ARCH_SSSE3_BIT) && (GLM_MODEL == GLM_MODEL_32)
      #pragma message( \
        "GLM: x86 32 bits with SSSE3 instruction set build target")
