...
struct _swizzle_base1<4, T, Q, E0, E1, E2, E3, Aligned> :
  ...
  GLM_FUNC_QUALIFIER vec<4, T, Q> operator()() const {
    return vec<4, T, Q>(
      this->elem(E0), this->elem(E1), this->elem(E2), this->elem(E3));
  }
};
...
template <int N, typename T, qualifier Q, int E0, int E1, int E2, int E3>
struct _swizzle :
  public _swizzle_base2<N, T, Q, E0, E1, E2, E3,
...
#define GLM_SWIZZLE_VECTOR_BINARY_OPERATOR_IMPLEMENTATION(OPERAND) \
  ...
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(                \
    const GLM_SWIZZLE_TYPE1& a, const vec<N, T, Q>& b) {           \
    return a() OPERAND b;                                          \
  }                                                                \
  GLM_SWIZZLE_TEMPLATE1                                            \
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(                \
...
#define GLM_SWIZZLE_SCALAR_BINARY_OPERATOR_IMPLEMENTATION(OPERAND) \
  GLM_SWIZZLE_TEMPLATE1                                            \
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(                \
    const GLM_SWIZZLE_TYPE1& a, const T& b) {                      \
    return a() OPERAND b;                                          \
  }                                                                \
  GLM_SWIZZLE_TEMPLATE1                                            \
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(                \
