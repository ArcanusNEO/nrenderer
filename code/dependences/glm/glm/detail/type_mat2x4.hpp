...
public:
  ...
  GLM_FUNC_DECL GLM_CONSTEXPR mat(
    T x0, T y0, T z0, T w0, T x1, T y1, T z1, T w1);
  ...
  GLM_FUNC_DECL GLM_CONSTEXPR mat(
    vec<4, U, Q> const& v1, vec<4, V, Q> const& v2);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL mat<2, 4, T, Q> operator+(
  mat<2, 4, T, Q> const& m1, mat<2, 4, T, Q> const& m2);
...
GLM_FUNC_DECL mat<4, 4, T, Q> operator*(
  mat<2, 4, T, Q> const& m1, mat<4, 2, T, Q> const& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL mat<2, 4, T, Q> operator*(
  mat<2, 4, T, Q> const& m1, mat<2, 2, T, Q> const& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL mat<3, 4, T, Q> operator*(
  mat<2, 4, T, Q> const& m1, mat<3, 2, T, Q> const& m2);
