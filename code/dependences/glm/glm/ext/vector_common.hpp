...
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, T, Q> min(
  vec<L, T, Q> const& a, vec<L, T, Q> const& b, vec<L, T, Q> const& c);
...
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, T, Q> min(vec<L, T, Q> const& a,
  vec<L, T, Q> const& b, vec<L, T, Q> const& c, vec<L, T, Q> const& d);
...
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, T, Q> max(
  vec<L, T, Q> const& x, vec<L, T, Q> const& y, vec<L, T, Q> const& z);
...
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, T, Q> max(vec<L, T, Q> const& x,
  vec<L, T, Q> const& y, vec<L, T, Q> const& z, vec<L, T, Q> const& w);
