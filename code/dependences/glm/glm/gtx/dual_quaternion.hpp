...
struct tdualquat {
  ...
  GLM_FUNC_DECL GLM_CONSTEXPR tdualquat(
    qua<T, Q> const& orientation, vec<3, T, Q> const& translation);
  GLM_FUNC_DECL GLM_CONSTEXPR tdualquat(
    qua<T, Q> const& real, qua<T, Q> const& dual);
  ...
  GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR tdualquat(
  ...
  GLM_FUNC_DECL tdualquat<T, Q>& operator=(
    tdualquat<T, Q> const& m) GLM_DEFAULT;
...
template <typename T, qualifier Q>
GLM_FUNC_DECL tdualquat<T, Q> operator+(
  tdualquat<T, Q> const& q, tdualquat<T, Q> const& p);
...
GLM_FUNC_DECL vec<3, T, Q> operator*(
  tdualquat<T, Q> const& q, vec<3, T, Q> const& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL vec<3, T, Q> operator*(
  vec<3, T, Q> const& v, tdualquat<T, Q> const& q);

template <typename T, qualifier Q>
GLM_FUNC_DECL vec<4, T, Q> operator*(
  tdualquat<T, Q> const& q, vec<4, T, Q> const& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL vec<4, T, Q> operator*(
  vec<4, T, Q> const& v, tdualquat<T, Q> const& q);
...
GLM_FUNC_DECL bool operator==(
  tdualquat<T, Q> const& q1, tdualquat<T, Q> const& q2);
...
template <typename T, qualifier Q>
GLM_FUNC_DECL tdualquat<T, Q> lerp(
  tdualquat<T, Q> const& x, tdualquat<T, Q> const& y, T const& a);
...
typedef tdualquat<double, highp> highp_ddualquat;
  ...
  !defined(GLM_PRECISION_MEDIUMP_FLOAT) && !defined(GLM_PRECISION_LOWP_FLOAT))
