...
GLM_FUNC_DECL GLM_CONSTEXPR vec<3, T, Q> cross(
  vec<3, T, Q> const& x, vec<3, T, Q> const& y);
...
GLM_FUNC_DECL vec<L, T, Q> faceforward(
  vec<L, T, Q> const& N, vec<L, T, Q> const& I, vec<L, T, Q> const& Nref);
...
GLM_FUNC_DECL vec<L, T, Q> reflect(
  vec<L, T, Q> const& I, vec<L, T, Q> const& N);
...
GLM_FUNC_DECL vec<L, T, Q> refract(
  vec<L, T, Q> const& I, vec<L, T, Q> const& N, T eta);
