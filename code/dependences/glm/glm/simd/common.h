...
GLM_FUNC_QUALIFIER glm_f32vec4 glm_vec1_fma(
  glm_f32vec4 a, glm_f32vec4 b, glm_f32vec4 c) {
...
GLM_FUNC_QUALIFIER glm_f32vec4 glm_vec4_fma(
  glm_f32vec4 a, glm_f32vec4 b, glm_f32vec4 c) {
  #if (GLM_ARCH & GLM_ARCH_AVX2_BIT) && !(GLM_COMPILER & GLM_COMPILER_CLANG)
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_clamp(
  glm_vec4 v, glm_vec4 minVal, glm_vec4 maxVal) {
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_smoothstep(
  glm_vec4 edge0, glm_vec4 edge1, glm_vec4 x) {
...
GLM_FUNC_QUALIFIER glm_vec4 glm_vec4_inf(glm_vec4 x) {
  ...
  return _mm_castsi128_ps(_mm_cmpeq_epi32(
    t2, _mm_set1_epi32(int(0xFF000000))));  // exponent is all 1s, fraction is 0
}
